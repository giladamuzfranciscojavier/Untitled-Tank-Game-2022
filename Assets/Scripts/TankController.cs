...
public class TankController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Se aplican las mejoras. Para el tanque pesado las mejoras de armadura repercutirán también en la masa (se aplicará una pequeña mejora de velocidad para compensar parcialmente)

        maxHealth*=GameManager.armorLevel;
        maxFrontArmor*=GameManager.armorLevel;
        maxEngineArmor*=GameManager.armorLevel;
        maxTrackArmor*=GameManager.armorLevel;

        health=maxHealth;
        frontArmor=maxFrontArmor;
        engineArmor=maxEngineArmor;
        lTrackArmor=rTrackArmor=maxTrackArmor;
        maxSpeed*=GameManager.speedLevel;
        acceleration*=GameManager.speedLevel;

        if(heavy){rb.mass*=GameManager.armorLevel; acceleration*=Mathf.Max(1,GameManager.armorLevel-.25f);}
    }
    ...
    */
    ...
    void RotateRight()
    {
        ...
        rb.AddTorque(-rotSpeed*GameManager.speedLevel);
    }
